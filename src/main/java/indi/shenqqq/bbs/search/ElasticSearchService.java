...
public class ElasticSearchService {
    ...
    public static XContentBuilder articleMappingBuilder;

    static {
        try {
            articleMappingBuilder = JsonXContent.contentBuilder()
                    .startObject()
    ...
    public RestHighLevelClient instance() {
        ...
        try {
            String host = systemConfigService.selectByKey("elasticsearch_host");
            String port = systemConfigService.selectByKey("elasticsearch_port");
            name = systemConfigService.selectByKey("elasticsearch_index");
//            String host = "119.3.8.118";
//            String port = "9200";
//            name = "bbs";
            ...
            // 判断索引是否存在，不存在创建
            if (!this.existIndex()) this.createIndex("article", articleMappingBuilder);
            return client;
